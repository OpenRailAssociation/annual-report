...
Through active community building, we attracted additional adopters and development partners. It was hard work, but the results are tangible — today, the project benefits from a diverse community of software developers, planners, designers, students, and enthusiasts. Half of the commits are coming from outside of SBB now. Such a broad and interdisciplinary community is an important prerequisite for advancing open innovation in the railway sector.
...
Opening the Netzgrafik-Editor has measurably changed how the tool evolves and how planning knowledge is shared across organisational boundaries. What began as an internal innovation project has developed into a collaborative solution that benefits from contributions across companies and disciplines.
...
- Collaborative development across organisations enables the implementation of new features that would be difficult to realise within a single organisational context.
- Collaboration across organisational boundaries reduces duplicated effort and supports interoperability between planning tools.
- Integrating user feedback from operational environments improves practical applicability.
- Transparency and openness support trust-building between organisations and partners.
